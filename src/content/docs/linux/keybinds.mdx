...
Sometimes you wanna open a file in vim/neovim, but you don't want to waste your
time looking around with `cd` and so on. A simple fix for this is using `fzf`
in the neovim/vim command to open a file
